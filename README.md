...
The Spark notebook (`football_es.ipynb`) loads `transformed_data.csv`, cleans and casts columns, computes match results, and aggregates statistics by team and season. Finally we save all the results.
